...
public class ShopsController {
    ...
    @PostMapping("/{id}")
    public String addNewShopPurchases(@PathVariable int id,@RequestBody String purchase){
        return gson.toJson(shopDAO.addNewPurchase(id, gson.fromJson(purchase, ShopPurchase.class)));
    }
